...
.ripple-effect {
  ...
  background: linear-gradient(
    90deg,
    transparent 0%,
    rgba(233, 30, 99, 0.15) 25%,
    rgba(244, 143, 177, 0.3) 50%,
...
<template>
  ...
  >
    <!-- 👇 Hover 波紋效果（從下往上） -->
    <div class="hover-ripple" :class="{ active: isHovering }"></div>

    <!-- 👇 點擊波紋效果（從左往右） -->
    <div class="click-ripple" :class="{ active: isRippling }"></div>
...
.hover-ripple {
  ...
  background: linear-gradient(
    to top,
    rgba(233, 30, 99, 0.25) 0%,      /* 粉色 */
    rgba(255, 87, 34, 0.2) 40%,      /* 橘色 */
    rgba(255, 193, 7, 0.15) 70%,     /* 黃色 */
    transparent 100%
  );
  z-index: 1;
  pointer-events: none;
...
.click-ripple {
  ...
  background: linear-gradient(
    ...
    rgba(244, 143, 177, 0.35) 50%,
    rgba(233, 30, 99, 0.2) 75%,
    transparent 100%
  );
  z-index: 2;
  pointer-events: none;
