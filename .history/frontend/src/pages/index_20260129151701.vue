    ...
    <v-row class="mb-6 align-center">
      ...
      <v-col class="d-flex align-center flex-wrap" cols="12" md="8">
        <v-chip-group v-model="category" color="blue-grey-darken-3" mandatory @update:model-value="fetchProducts">
          ...
          <v-chip color="pink-lighten-4" filter value="甜點" variant="flat" class="brand-font">甜點 🍰</v-chip>
          <v-chip color="orange-lighten-4" filter value="零食" variant="flat" class="brand-font">零食 🍪</v-chip>
          <v-chip color="amber-lighten-4" filter value="熟食" variant="flat" class="brand-font">熟食 🍱</v-chip>
          <v-chip color="blue-lighten-4" filter value="冰品" variant="flat" class="brand-font">冰品 🍦</v-chip>
          <v-chip color="red-lighten-4" filter value="泡麵" variant="flat" class="brand-font">泡麵 🍜</v-chip>
        </v-chip-group>
