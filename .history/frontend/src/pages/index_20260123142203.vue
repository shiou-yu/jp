<script setup>
  ...
  const products = ref([
    {
      ...
      rating: 0, reviewCount: 0, description: '能盡情品嚐使用100%鮮奶油的奶油！',
      image: 'https://cdn.vuetifyjs.com/images/cards/sunshine.jpg'
    },
    {
      id: 2, name: '冬日巧克力', price: 244, tag: '甜點',
      rating: 5, reviewCount: 1, description: '一款以生巧克力製成的美味巧克力甜點。',
  ...
  const toggleFavorite = (id) => { console.log('收藏 ID:', id) }
</script>
        ...
        <v-card class="mx-auto rounded-lg d-flex flex-column fill-height" elevation="1" hover color="white">
          ...
          <div class="d-flex flex-column flex-grow-1 pa-4">
            ...
            <div class="d-flex justify-end mt-auto">
              <v-btn icon="mdi-heart" color="pink-accent-2" variant="text" density="comfortable" @click="toggleFavorite(product.id)"></v-btn>
            </div>
          </div>
        </v-card>
      </v-col>
