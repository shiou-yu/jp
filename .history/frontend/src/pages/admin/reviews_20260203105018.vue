      ...
      <v-col cols="12">
        ...
        <v-card class="header-card mb-6" elevation="8">
          <div class="header-content">
            <v-icon size="64" color="white">mdi-comment-text-multiple</v-icon>
        ...
        <v-row class="mb-4">
          <v-col cols="12" sm="6" md="3">
            <v-card class="stat-card" elevation="2">
              <v-card-text class="text-center pa-4">
                <v-icon size="40" color="blue">mdi-comment-text</v-icon>
          ...
          <v-col cols="12" sm="6" md="3">
            <v-card class="stat-card" elevation="2">
              <v-card-text class="text-center pa-4">
                <v-icon size="40" color="orange">mdi-clock-alert</v-icon>
