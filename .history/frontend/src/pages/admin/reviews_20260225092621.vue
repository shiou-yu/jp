            ...
            <template #item.user="{ item }">
              <div class="d-flex align-center">
                <v-avatar class="mr-2" size="32">
                  <v-img :src="`https://api.dicebear.com/9.x/avataaars/svg?seed=${item.user}`"></v-img>
                </v-avatar>
              ...
              <div class="detail-section">
                ...
                <div class="d-flex align-center">
                  <v-avatar class="mr-3" size="40">
                    <v-img :src="`https://api.dicebear.com/9.x/avataaars/svg?seed=${selectedReview.user}`"></v-img>
                  </v-avatar>
