  ...
  <v-container class="admin-home-container" fluid>
    <v-row align="center" class="fill-height" justify="center">
      <v-col cols="12" lg="8" md="10">
                ...
                >
                  <v-card-text class="text-center pa-6">
                    <div class="feature-icon-wrapper mb-4">
                      <v-icon color="blue-grey-darken-2" size="48">mdi-food</v-icon>
                    </div>
        ...
        >
          <template #prepend>
            <v-icon color="blue-grey-darken-2">mdi-information</v-icon>
          </template>
...
/* 漸層標題區 */
.welcome-header {
  background: linear-gradient(135deg, #5DADE2 0%, #2E86C1 50%, #1A5276 100%);
  padding: 60px 32px;
  text-align: center;
