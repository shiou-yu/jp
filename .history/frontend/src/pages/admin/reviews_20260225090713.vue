      ...
      <v-col cols="12">
        ...
        <v-card class="reviews-table-card" elevation="4">
          <v-card-title class="pa-6 bg-grey-lighten-4">
            <v-icon class="mr-2" color="brown-darken-1">mdi-format-list-bulleted</v-icon>
            ...
            <template #item.user="{ item }">
              <div class="d-flex align-center">
                <v-avatar class="mr-2" size="32">
                  <v-img :src="`https://source.boringavatars.com/beam/120/${item.user}?colors=D7B896,C4956A,A0714F,F5E6D0,FFF9E6`"></v-img>
                </v-avatar>
