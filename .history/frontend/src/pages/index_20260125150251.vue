...
const slides = ref([
  {
    // ★★★ 請將下面這行網址換成您從 Lawson 網頁複製下來的圖片連結 ★★★
    src: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476d?q=80&w=1920&auto=format&fit=crop'
  },
  { src: 'https://images.unsplash.com/photo-1554502078-ef0fc409efce?q=80&w=1920&auto=format&fit=crop' },
  { src: 'https://images.unsplash.com/photo-1588611910609-0268f7b7f147?q=80&w=1920&auto=format&fit=crop' },
])
// ==========================================
