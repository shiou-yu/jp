<template>
  <v-container>
    <v-row class="mt-4">
      <v-col cols="12" md="6">
        <v-img aspect-ratio="1" class="rounded-xl elevation-3 bg-white" cover :src="product.image"></v-img>
      </v-col>
      ...
      <v-col class="d-flex flex-column justify-center" cols="12" md="6">
        ...
        <div class="text-h5 text-brown-darken-1 mb-6 font-weight-bold">{{ currency(product.price) }}</div>
    ...
    <div v-if="product._id">
      <ProductReviews :id="product._id"></ProductReviews>
    </div>
